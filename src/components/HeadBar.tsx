...
import { bot, burguer, homePage, minecraft } from "../icons/HeadBar"
...
export default function TopHeadBar() {
	...
	return (
		<div className={"TopHeadBar flex justify-center items-center font-semibold "}>
			...
			<div className="hidden cursor-pointer md:flex md:absolute top-10 right-10 text-white" onClick={(e) => setMenu(!menu)}>
				{burguer}
			</div>
		</div>
	)
